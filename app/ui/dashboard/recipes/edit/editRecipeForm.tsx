...
export default function RecipeForm({
  ...
  const [checkState, setCheckState] = useState(recipe.favorite);
  ...
  return (
    ...
    >
      <input type="hidden" name="id" id="id" value={recipe.id} readOnly />
      <input
        type="hidden"
        name="ingredients"
      ...
      >
        ...
        <input
          ...
          className="peer  block w-full rounded-md border border-bistre-200 py-[9px] text-center text-lg font-normal outline-2 placeholder:text-gray-500 invalid:border-4 invalid:border-red-600"
          required
        />
      </label>
      <label
      ...
      >
        <ImageFromDB
          ...
          className="mx-auto rounded-md object-cover print:w-1/2 lg:w-2/3"
          width={800}
          height={600}
        />
        Image
        <input
          ...
          name="image"
          id="image"
          className="peer block w-full rounded-md border border-bistre-200 py-[9px] text-lg outline-2 placeholder:text-gray-500"
        />
      </label>
      <label
        htmlFor="favorite"
      ...
      >
        ...
        <input
          ...
          id="cookTime"
          step={0.1}
          defaultValue={recipe.cookTime / 60}
          className="peer block w-full rounded-md border border-bistre-200 py-[9px] text-center text-lg font-normal outline-2 placeholder:text-gray-500 invalid:border-4 invalid:border-red-600"
          required
        />
      </label>
      ...
      >
        ...
        <textarea
          ...
          rows={10}
          className="peer block w-full rounded-md border border-bistre-200 py-[9px] text-lg font-normal outline-2 placeholder:text-gray-500"
        ></textarea>
      </label>
      <button
        type="submit"
      ...
      >
        Edit Recipe <PencilIcon className="w-5" />
      </button>
      {errorMessage && (
